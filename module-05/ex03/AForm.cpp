...
/*   Updated: 2023/08/18 09:51:17 by haghouli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const AForm & obj) : name(obj.name) , is_signed(obj.is_signed),grade_to_be_signed(obj.grade_to_be_signed), grade_to_be_executed(obj.grade_to_be_executed){
	*this = obj;	
}
